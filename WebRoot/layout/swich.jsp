...
<td id="leftbar" style="display: none; background:url(${pageContext.request.contextPath}/Assets/images/switchbg.jpg) repeat-y #d2d2d0 0px 0">
<a onClick="switchSysBar()" href="javascript:void(0);">
<img src="${pageContext.request.contextPath}/Assets/images/pic24.jpg" width="12" height="72" border="0" alt="" >
</a>
</td>
<td id="rightbar"style="background:url(${pageContext.request.contextPath}/Assets/images/switchbg.jpg) repeat-y #f2f0f5 0px 0">
<a onClick="switchSysBar()" href="javascript:void(0);">
<img src="${pageContext.request.contextPath}/Assets/images/pic23.jpg" width="12" height="72" border="0" alt="" >
</a>
</td>
</tr>
</tbody>
