	...
	function showMsg(uuid){
		...
		$(".popBottom").on('click', 'span', function(event) {
			...
			if($(this).hasClass('confirm')){
				window.location = "menu_delete.action?mm.uuid="+uuid;
				$(".pop").fadeOut();
			}else{
				$(".pop").fadeOut();
			}
...
<body>
	<!--main_top-->
	<s:form method="post" action="menu_list">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="22%" height="40" align="left" valign="middle">
	         <span>菜单名称：</span>
	         <s:textfield name="mqm.name" cssClass="text-word" />
         </td>
   		 <td width="22%" align="left" valign="middle">
   		 <span>所属菜单：</span>
   		 <s:select name="mqm.parent.uuid" list="parentList" listKey="uuid" listValue="name" headerKey="-1" headerValue="----请-选-择----" cssClass="text-word"></s:select>
   		 </td>
  		 <td width="150" align="center" valign="middle" style="text-align:right; width:150px;">
  		  <input id="query" type="image" value="查询" style="width: 100;height: 30px;" src="${pageContext.request.contextPath}/Assets/images/serach.jpg"></td>
  		  <td width="10%" align="center" valign="middle"
								style="text-align:right; width:150px;"><a
								href="menu_input.action" target="mainFrame" onFocus="this.blur()"
								class="add">新增菜单</a></td>
	    </tr>
		</table>
				</td>
				...
				<td align="left" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<th align="center" valign="middle" class="borderright">菜单名称</th>
							<th align="center" valign="middle" class="borderright">所属菜单</th>
							<th align="center" valign="middle" class="borderright">菜单链接</th>
						...
						<s:iterator value="menuList">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="center" valign="middle"
									...
									<td align="center" valign="middle"
									class="borderright borderbottom">${parent.name}</td>
								<td align="center" valign="middle"
									class="borderright borderbottom">${url}</td>
								<td align="center" valign="middle" class="borderbottom"><s:a
										action="menu_input" cssClass="add" target="mainFrame"
										onFocus="this.blur()">
										<s:param name="mm.uuid" value="uuid" />
								编辑
								</s:a> <span class="gray">&nbsp;|&nbsp;</span> <a
										href="javascript:void(0)" class="add" target="mainFrame"
										onFocus="this.blur()" onclick="showMsg(${uuid})">删除<s:param name="mm.uuid" value="uuid" /><a></td>
							</tr>
						</s:iterator>
					</table>
				</td>
