...
<body>
	<!--main_top-->
	<s:form method="post" action="supplier_list">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="22%" height="40" align="left" valign="middle">
	         <span>供应商名：</span>
	         <s:textfield name="sqm.name" cssClass="text-word" />
         </td>
   		 <td width="22%" align="left" valign="middle">
   		 <span>角色编码：</span>
   		 <s:textfield name="sqm." cssClass="text-word" />
   		 </td>
  		 <td width="150" align="center" valign="middle" style="text-align:right; width:150px;">
  		  ...
  		  <td width="10%" align="center" valign="middle"
								...
								href="supplier_input.action" target="mainFrame" onFocus="this.blur()"
								class="add">新增供应商</a></td>
	    </tr>
		</table>
				</td>
			</tr>
