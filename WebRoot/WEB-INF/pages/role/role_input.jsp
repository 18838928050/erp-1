...
$(function() {
		$("#all").click(function() {
			$("[name=resourceUuids]:checkbox").attr("checked",$("#all").attr("checked")=="checked");
		});
		$("#reverse").click(function() {
			$("[name=resourceUuids]:checkbox").each(function () {
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <s:form method="post" action="role_save.action">
    <s:hidden name="rm.uuid"/>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td width="130" align="right" valign="middle" class="borderright borderbottom bggray">角色名：</td>
        <td width="333" align="left" valign="middle" class="borderright borderbottom main-for">
          <s:textfield name="rm.name" cssClass="text-word" />
        </td>
        <td width="154" align="right" valign="middle" class="borderright borderbottom bggray">角色编码：</td>
        <td width="303" align="left" valign="middle" class="borderright borderbottom main-for">
        <s:textfield name="rm.code" cssClass="text-word" />
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">资源名称：</td>
       ...
       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" colspan="3">
       	 ...
       	 <s:checkboxlist name="resourceUuids" list="resourceList" listKey="uuid" listValue="name"></s:checkboxlist> 
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">&nbsp;</td>
