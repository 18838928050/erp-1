	...
	function showMsg(uuid){
		...
		$(".popBottom").on('click', 'span', function(event) {
			...
			if($(this).hasClass('confirm')){
				window.location = "resource_delete.action?rsm.uuid="+uuid;
				$(".pop").fadeOut();
			}else{
				$(".pop").fadeOut();
			}
...
<body>
	<!--main_top-->
	<s:form method="post" action="resource_list">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="22%" height="40" align="left" valign="middle">
	         <span>资源名称：</span>
	         <s:textfield name="rsqm.name" cssClass="text-word" />
         </td>
   		 <td width="22%" align="left" valign="middle">
   		 <span>资源链接：</span>
   		 <s:textfield name="rsqm.url" cssClass="text-word" />
   		 </td>
  		 <td width="150" align="center" valign="middle" style="text-align:right; width:150px;">
  		  ...
  		  <td width="10%" align="center" valign="middle"
								...
								href="resource_input.action" target="mainFrame" onFocus="this.blur()"
								class="add">新增资源</a></td>
	    </tr>
		</table>
				</td>
				...
				<td align="left" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<th align="center" valign="middle" class="borderright">资源名称</th>
							<th align="center" valign="middle" class="borderright">资源链接</th>
						...
						<s:iterator value="resourceList">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="center" valign="middle" class="borderbottom"><s:a
										action="resource_input" cssClass="add" target="mainFrame"
										onFocus="this.blur()">
										<s:param name="rsm.uuid" value="uuid" />
								编辑
								</s:a> <span class="gray">&nbsp;|&nbsp;</span><a
										herf="javascript:void(0)" class="add" target="mainFrame"
										onFocus="this.blur()" onclick="showMsg(${uuid})">删除 <s:param name="rsm.uuid" value="uuid" /></a></td>
							</tr>
						</s:iterator>
					</table>
				</td>
